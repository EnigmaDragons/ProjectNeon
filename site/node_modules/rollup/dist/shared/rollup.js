...
function loadFsEvents() {
    return Promise.resolve().then(function () { return _interopNamespace(require('fsevents')); })
        .then(namespace => {
...
class Chunk$1 {
    ...
    generateIdPreserveModules(preserveModulesRelativeDir, options, existingNames, unsetOptions) {
        ...
        if (isAbsolute(id)) {
            ...
            path$1 = relative(preserveModulesRelativeDir, `${path.dirname(sanitizedId)}/${renderNamePattern(pattern, 'output.entryFileNames', {
...
class WatchEmitter extends events.EventEmitter {
    constructor() {
        super();
