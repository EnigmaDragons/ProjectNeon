...
function mergeOptions(config, rawCommandOptions = { external: [], globals: undefined }, defaultOnWarnHandler = rollup_js.defaultOnWarn) {
...
function mergeInputOptions(config, overrides, defaultOnWarnHandler) {
    ...
    const inputOptions = {
        ...
        perf: getOption('perf'),
        plugins: rollup_js.ensureArray(config.plugins),
    ...
    rollup_js.warnUnknownOptions(config, Object.keys(inputOptions), 'input options', inputOptions.onwarn, /^output$/);
    return inputOptions;
}
const getExternal = (config, overrides) => {
    ...
    return typeof configExternal === 'function'
        ...
        : rollup_js.ensureArray(configExternal).concat(overrides.external);
};
...
function mergeOutputOptions(config, overrides, warn) {
    ...
    rollup_js.warnUnknownOptions(config, Object.keys(outputOptions), 'output options', warn);
