...
public static class CurrentGameData
{
    ...
    public static void MutateIfInitialized(Action<GameData> mutate)
    {
        WriteIfInitialized(g =>
        {
            mutate(g);
            return g;
        });
    ...
    public static void WriteIfInitialized(Func<GameData, GameData> transform)
    {
