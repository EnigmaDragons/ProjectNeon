...
public class CardTypeEditor : Editor
{
    ...
    private SerializedProperty art, description, typeDescription, tags, onlyPlayableByClass, cost, gain, instant, rarity, actionSequences, cardAction1, cardAction2, chainedCard;
