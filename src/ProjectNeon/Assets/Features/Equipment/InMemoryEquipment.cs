...
public class InMemoryEquipment : Equipment
{
    ...
    public EffectData[] BattleEndEffects
    {
        get => battleEndEffects;
        set => battleEndEffects = value;
    }
    ...
    public Maybe<CardTypeData> ReferencedCard { get; } = Maybe<CardTypeData>.Missing();
