...
public class EffectDataEditor : PropertyDrawer
{
        ...
        new DictionaryWithDefault<EffectType, string[]>(new string[] { "BaseAmount", "FloatAmount", "DurationFormula", "HitsRandomTargetMember" })
    {
        ...
        {EffectType.AdjustCounterMaxFormula, new [] {"Formula", "InterpolatePartialFormula", "EffectScope", "Unpreventable" }},
        ...
        {EffectType.SetScopedVariableToRandom, new [] { "EffectScope", "FloatAmount" }},
    };
