...
public static class DialogTerms
{
    public static string OptionLeave = "Dialogs/Option-Leave";
    public static string OptionStay = "Dialogs/Option-Stay";
    public static string OptionYes = "Dialogs/Option-Yes";
    public static string OptionNo = "Dialogs/Option-No";
    public static string OptionGotIt = "Dialogs/Option-Got it!";
