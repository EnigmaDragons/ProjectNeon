...
namespace AeLa.EasyFeedback.Web
{
    ...
    internal static class WebInterface
    {
        ...
        {
            return _waitForResponse(_makeGet(uri), onStatusUpdate);
        }
        ...
        )
        {
            return _waitForResponse(
                _makePost(uri, contentType, data), onStatusUpdate
            );
        }
        ...
        {
            return _waitForResponseCoroutine(
                _makePost(uri, data), onResponseReturned
            );
        }
        ...
        {
            return _waitForResponseCoroutine(
                _makePost(uri, contentType, data), onResponseReturned
            );
        }
        ...
        {
            return _waitForResponse(
                _makePut(uri, contentType, data), onStatusUpdate
            );
        }
        ...
        {
            return _waitForResponseCoroutine(
                _makePut(uri, contentType, data), onResponseReturned
            );
        }
        ...
        {
            return _makeRequest(uri, WebRequestMethod.GET);
        }
        ...
        /// <param name="data">The request payload</param>
        /// <returns>The web request and async operation</returns>
        private static AsyncWebRequestData _makePost(
        ...
        /// <param name="data">The request payload</param>
        /// <returns>The web request and async operation</returns>
        private static AsyncWebRequestData _makePut(
        ...
        /// <param name="data">The request payload</param>
        /// <returns>The web request and async operation</returns>
        private static AsyncWebRequestData _makeRequest(
            string uri,
        ...
        )
        {
            ...
            UnityWebRequest request = _constructWebRequest(
...
#pragma warning restore 0618
        ...
        private static WebResponse _waitForResponse(
        ...
        /// <param name="requestData">The web request</param>
        /// <param name="onResponseReturned">Called when the request has finished and a response has been returned</param>
        private static IEnumerator _waitForResponseCoroutine(
            AsyncWebRequestData requestData,
        ...
        private static UnityWebRequest _constructWebRequest(
            string uri,
            WebRequestMethod method,
            string contentType = null,
            byte[] data = null
        )
        {
            ...
            UnityWebRequest request = new UnityWebRequest(
                uri, _getRequestMethodString(method)
        ...
        /// <returns></returns>
        private static bool _remoteCertificateValidationCallback(
