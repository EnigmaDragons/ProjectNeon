namespace AeLa.EasyFeedback.Utility
{
    public static class Markdown
    {
        ...
        public static string Header(
            string text, HeaderLevel level = HeaderLevel.H1
        )
        {
            switch (level)
            {
            ...
            throw new System.ArgumentException(
                "The header level value '" + level + "' is invalid."
            );
        }
        ...
        public static string Hyperlink(string text, string url) =>
            _LINK_INLINE_PRE + text + _LINK_INLINE_MID + url + _LINK_INLINE_END;
        ...
        public static string Image(string url, string alt = "") =>
            _IMG_INLINE_PRE + alt + _IMG_INLINE_MID + url + _IMG_INLINE_END;
        ...
        public static string Code(string text) =>
            _CODE_INLINE + text + _CODE_INLINE;
        ...
        public static string CodeBlock(string text, string language = "") =>
            _CODE_BLOCK + language + _ENDL + text + _ENDL + _CODE_BLOCK;
