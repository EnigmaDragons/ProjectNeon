...
Shader "Hidden/CC2D/Character Skin Baked"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 lerpResult42 = lerp( ( 2.0 * _SkinColor * tex2DNode11 ) , ( 2.0 * tex2DNode11 * tex2DNode2 * _DetailsColor ) , ( tex2DNode2.a * _DetailsColor.a ));
