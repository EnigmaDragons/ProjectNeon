...
Shader "CC2D/Lit (Built-in)/Character Skin"
{
	Properties
	{
	...
	SubShader
	{
		...
		{
			float3 switchResult93 = (((i.ASEVFace>0)?(float3(0,0,1)):(float3(0,0,-1))));
			o.Normal = switchResult93;
			...
			float4 lerpResult42 = lerp( ( 2.0 * i.vertexColor * tex2DNode11 ) , ( 2.0 * tex2DNode11 * tex2DNode2 * _DetailsColor ) , ( tex2DNode2.a * _DetailsColor.a ));
			o.Albedo = ( _Color * lerpResult42 ).rgb;
			o.Alpha = ( _Color.a * i.vertexColor.a * tex2DNode11.a );
		}
