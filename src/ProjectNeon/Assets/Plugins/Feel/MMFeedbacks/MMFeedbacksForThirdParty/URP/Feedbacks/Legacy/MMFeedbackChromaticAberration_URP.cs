...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMFeedbackChromaticAberration_URP : MMFeedback
    {
        ...
        protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            MMChromaticAberrationShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, channel:Channel, stop:true);
