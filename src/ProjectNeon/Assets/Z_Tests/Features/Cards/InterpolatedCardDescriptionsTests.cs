...
public sealed class InterpolatedCardDescriptionsTests
{
    ...
    private string Description(string s, EffectData e, Maybe<Member> owner, ResourceQuantity xCost) 
        => InterpolatedCardDescriptions.InterpolatedDescription(s, new[] {e}, new EffectData[0], owner, xCost, Maybe<CardTypeData>.Missing(), CardTimingType.Standard);
    ...
    private string ReactionDescription(string s, EffectData re, Maybe<Member> owner, ResourceQuantity xCost) 
        => InterpolatedCardDescriptions.InterpolatedDescription(s, new EffectData[0], new [] {re}, owner, xCost, Maybe<CardTypeData>.Missing(), CardTimingType.Standard);
