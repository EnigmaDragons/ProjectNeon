...
{
    private EffectData Vulnerable(int duration = 1) => new EffectData { EffectType = EffectType.AdjustCounterFormula, Formula = duration.ToString(), EffectScope = new StringReference(TemporalStatType.Vulnerable.ToString()) };
